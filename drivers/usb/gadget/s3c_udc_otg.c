...
#define	DRIVER_DESC		"S5P HS USB Device Controller Driver, (c) 2008-2011 Samsung Electronics"
#define	DRIVER_VERSION		"24 Feb 2011"

struct s3c_udc	*the_controller;

static struct clk	*otg_clock;
static const char driver_name[] = "s5p-udc";
 ...
 */
static inline void done(struct s3c_ep *ep, struct s3c_request *req, int status)
{
